...
| Phase | Focus | Tickets | Est. Hours | Duration |
|-------|-------|---------|------------|----------|
| **Phase 1** | Foundation | 1-3 | 16-20 | Week 1 |
| **Phase 2** | Core Backend | 4-8 | 28-34 | Week 2 |
| **Phase 3** | Frontend & UI | 9-11 | 20-26 | Week 2-3 |
| **Phase 4** | DevOps & Deploy | 12-14 | 12-16 | Week 3 |
| **Phase 5** | Hardening | 15-16 | 8-12 | Week 4 |
| **Total** | | 16 tickets | **84-108 hrs** | **4 weeks** |
...
**Priority:** Critical | **Effort:** 4-6 hrs | **Dependencies:** None
...
**Priority:** Critical | **Effort:** 4-5 hrs | **Dependencies:** Ticket 1
...
**Priority:** Critical | **Effort:** 3-4 hrs | **Dependencies:** Ticket 2
...
**Priority:** Critical | **Effort:** 5-6 hrs | **Dependencies:** Ticket 2, 3
...
**Priority:** Critical | **Effort:** 6-8 hrs | **Dependencies:** Ticket 4
...
**Priority:** High | **Effort:** 4-5 hrs | **Dependencies:** Ticket 5
...
**Priority:** High | **Effort:** 3-4 hrs | **Dependencies:** Ticket 4
...
**Priority:** High | **Effort:** 6-8 hrs | **Dependencies:** Ticket 5, 6, 7
...
**Priority:** Critical | **Effort:** 3-4 hrs | **Dependencies:** Ticket 1
...
**Priority:** Critical | **Effort:** 8-10 hrs | **Dependencies:** Ticket 9
...
**Priority:** High | **Effort:** 4-6 hrs | **Dependencies:** Ticket 10
...
**Priority:** Critical | **Effort:** 4-5 hrs | **Dependencies:** Ticket 1, 2
...
**Priority:** High | **Effort:** 4-6 hrs | **Dependencies:** Ticket 12
...
**Priority:** Medium | **Effort:** 3-4 hrs | **Dependencies:** Ticket 12
...
**Priority:** High | **Effort:** 4-6 hrs | **Dependencies:** All prior
...
**Priority:** Medium | **Effort:** 3-4 hrs | **Dependencies:** All prior
...
| Week | Tickets | Milestone |
|------|---------|-----------|
| Week 1 | 1-3 | Foundation: Flask, Database, Common utilities |
| Week 2 | 4-8 | Core Backend: Auth, Grocery, Favorites, Household, Tests |
| Week 2-3 | 9-11 | Frontend: Tailwind, Main UI, HTMX |
| Week 3 | 12-14 | DevOps: Docker, Deploy, Backups |
| Week 4 | 15-16 | Hardening, Documentation, Polish |

### Effort Summary

| Phase | Hours | Focus |
|-------|-------|-------|
| Foundation | 11-15 | Infrastructure |
| Backend | 28-34 | Core functionality |
| Frontend | 15-20 | UI/UX |
| DevOps | 11-15 | Deployment |
| Hardening | 7-10 | Quality |
| **Total** | **72-94** | |

### Definition of Done (v1)

- [x] Household creation and member join works
- [x] Grocery items can be added, viewed, checked, confirmed
- [x] Favorites can be managed and used for quick-add
- [x] Concurrent edits don't corrupt data
- [x] Mobile UI is usable in daily life
- [x] Core tests pass
